from constants.AUTH_CONSTANTS import EC_LEADERSHIP_ROLE, NATIONAL_REPORT_VIEWER_ROLE, \
    ...
    ELECTORAL_DISTRICT_REPORT_VIEWER_ROLE, ELECTORAL_DISTRICT_REPORT_VERIFIER_ROLE, ACCESS_TYPE_READ, ACCESS_TYPE_LOCK, ACCESS_TYPE_UNLOCK, \
    ACCESS_TYPE_WRITE, ACCESS_TYPE_SUBMIT
from constants.TALLY_SHEET_CODES import PRE_41, PRE_30_PD, PRE_30_ED, PRE_34_CO, PRE_34_I_RO, PRE_34_II_RO, \
    PRE_34, PRE_ALL_ISLAND_RESULTS_BY_ELECTORAL_DISTRICTS, PRE_ALL_ISLAND_RESULTS, CE_201_PV, CE_201, PRE_34_PD, \
    PRE_34_ED, PRE_34_AI
...
role_based_access_config = {DATA_EDITOR_ROLE: {
    PRE_41: {
...
role_based_access_config[POLLING_DIVISION_REPORT_VIEWER_ROLE]: {
    PRE_30_PD: {
...
role_based_access_config[POLLING_DIVISION_REPORT_VERIFIER_ROLE]: {
    PRE_41: {
...
role_based_access_config[ELECTORAL_DISTRICT_REPORT_VIEWER_ROLE]: {
    PRE_30_PD: {
        Postal: [READ, WRITE]
    },
    PRE_34_I_RO: {
...
role_based_access_config[ELECTORAL_DISTRICT_REPORT_VERIFIER_ROLE]: {
    PRE_41: {
        Postal: [READ, UNLOCK]
    },
    CE_201_PV: {
...
role_based_access_config[NATIONAL_REPORT_VIEWER_ROLE]: {
...
role_based_access_config[EC_LEADERSHIP_ROLE]: {
    PRE_41: {
        Postal: [READ],
        NonPostal: [READ]
    },
