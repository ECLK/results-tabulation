...
class ExtendedTallySheetVersion_CE_201(ExtendedTallySheetVersion):

    def html_letter(self, title="", total_registered_voters=None):
        return super(ExtendedTallySheetVersion_CE_201, self).html_letter(
    ...
    def html(self, title="", total_registered_voters=None):
        ...
        for polling_station_wise_number_of_ballots_recieved_item_index, polling_station_wise_number_of_ballots_recieved_item in polling_station_wise_number_of_ballots_recieved.iterrows():
            ...
            data_row.append(Area.get_associated_areas(
                tallySheetVersion.submission.area, AreaTypeEnum.PollingDistrict)[polling_station_wise_number_of_ballots_recieved_item_index].areaName)
