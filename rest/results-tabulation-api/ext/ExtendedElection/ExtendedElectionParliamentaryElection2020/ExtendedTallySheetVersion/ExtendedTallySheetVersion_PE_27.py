...
class ExtendedTallySheetVersion_PE_27(ExtendedTallySheetVersion):

    def __init__(self, tallySheetVersion):
        super(ExtendedTallySheetVersion_PE_27, self).__init__(tallySheetVersion)

    def html_letter(self, title="", total_registered_voters=None):
        return super(ExtendedTallySheetVersion_PE_27, self).html_letter(
