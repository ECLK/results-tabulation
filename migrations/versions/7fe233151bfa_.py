...
Revision ID: 7fe233151bfa
Revises: 
Create Date: 2019-08-26 15:19:29.838466
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('ballotId', 'electionId'),
    sa.UniqueConstraint('stationaryItemId')
    )
    ...
    sa.ForeignKeyConstraint(['electionId'], ['election.electionId'], ),
    sa.ForeignKeyConstraint(['stationaryItemId'], ['stationaryItem.stationaryItemId'], ),
    sa.PrimaryKeyConstraint('ballotBoxId', 'electionId'),
    sa.UniqueConstraint('stationaryItemId')
    )
    ...
    sa.Column('issuedBallotCount', sa.Integer(), nullable=False),
    sa.Column('issuedTenderBallotCount', sa.Integer(), nullable=False),
    sa.Column('receivedBallotCount', sa.Integer(), nullable=False),
    sa.Column('receivedTenderBallotCount', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['areaId'], ['area.areaId'], ),
