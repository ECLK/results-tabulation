...
import TallySheetList, {TALLY_SHEET_LIST_COLUMN} from "../components/tally-sheet/tally-sheet-list";
import {TALLY_SHEET_LIST_ROW_ACTION} from "../components/tally-sheet/tally-sheet-list/tally-sheet-list-row-action";
...
export default function DataEntryList({history, queryString, election}) {
    ...
    return <TallySheetList
        history={history} election={election} tallySheetCode={tallySheetCode}
        columns={[
            TALLY_SHEET_LIST_COLUMN.TALLY_SHEET_LIST_COLUMN_ELECTORAL_DISTRICT,
            TALLY_SHEET_LIST_COLUMN.TALLY_SHEET_LIST_COLUMN_POLLING_DIVISION,
            TALLY_SHEET_LIST_COLUMN.TALLY_SHEET_LIST_COLUMN_COUNTING_CENTRE,
            TALLY_SHEET_LIST_COLUMN.TALLY_SHEET_LIST_COLUMN_STATUS,
            TALLY_SHEET_LIST_COLUMN.TALLY_SHEET_LIST_COLUMN_ACTIONS
        ]}
        actions={[
            TALLY_SHEET_LIST_ROW_ACTION.TALLY_SHEET_LIST_ROW_ACTION_ENTER,
            TALLY_SHEET_LIST_ROW_ACTION.TALLY_SHEET_LIST_ROW_ACTION_EDIT,
