    ...
    def get_object(election, row, row_key, data_key=None):
        ...
        if obj is None:
            if data_store_key == "Ballot":
                ...
                TallySheet.create(
                    tallySheetCode=TallySheetCodeEnum.PRE_34, electionId=postal_election.electionId,
                    areaId=obj.areaId
                )
                TallySheet.create(
                    tallySheetCode=TallySheetCodeEnum.PRE_34_II_RO, electionId=postal_election.electionId,
                    areaId=obj.areaId
                )
                TallySheet.create(
