...
export const TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT = "TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT";
...
export const TALLY_SHEET_LIST_COLUMN_PROVINCE = "TALLY_SHEET_LIST_COLUMN_PROVINCE";
...
export const TALLY_SHEET_LIST_COLUMN_LABEL = {
    ...
    [TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT]: "Administrative District",
    [TALLY_SHEET_LIST_COLUMN_POLLING_DIVISION]: "Polling Division",
    [TALLY_SHEET_LIST_COLUMN_COUNTING_CENTRE]: "Counting Centre",
    [TALLY_SHEET_LIST_COLUMN_PROVINCE]: "Province",
...
export const TALLY_SHEET_LIST_COLUMN_VALUE = {
    ...
    [TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT]: (tallySheet) => tallySheet["administrativeDistrictName"],
    ...
    [TALLY_SHEET_LIST_COLUMN_PROVINCE]: (tallySheet) => tallySheet["provinceName"],
