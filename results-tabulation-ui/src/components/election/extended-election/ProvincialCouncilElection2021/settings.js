...
const columns_ad_pd_cc_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_POLLING_DIVISION,
...
const columns_ad_cc_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_COUNTING_CENTRE, TALLY_SHEET_LIST_COLUMN_STATUS,
    TALLY_SHEET_LIST_COLUMN_ACTIONS];
const columns_ad_cc_party_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_COUNTING_CENTRE, TALLY_SHEET_LIST_COLUMN_PARTY,
    TALLY_SHEET_LIST_COLUMN_STATUS, TALLY_SHEET_LIST_COLUMN_ACTIONS];
const columns_ad_pd_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_POLLING_DIVISION, TALLY_SHEET_LIST_COLUMN_STATUS,
    TALLY_SHEET_LIST_COLUMN_ACTIONS];
const columns_ad_pd_party_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_POLLING_DIVISION, TALLY_SHEET_LIST_COLUMN_PARTY,
    TALLY_SHEET_LIST_COLUMN_STATUS, TALLY_SHEET_LIST_COLUMN_ACTIONS];
const columns_ad_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_STATUS, TALLY_SHEET_LIST_COLUMN_ACTIONS];
const columns_ad_party_status_actions = [
    TALLY_SHEET_LIST_COLUMN_ADMINISTRATIVE_DISTRICT, TALLY_SHEET_LIST_COLUMN_PARTY, TALLY_SHEET_LIST_COLUMN_STATUS,
    TALLY_SHEET_LIST_COLUMN_ACTIONS];
