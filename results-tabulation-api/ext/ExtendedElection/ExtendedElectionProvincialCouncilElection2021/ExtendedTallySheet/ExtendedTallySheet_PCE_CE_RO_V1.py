...
class ExtendedTallySheet_PCE_CE_RO_V1(ExtendedTallySheetReport):
    ...
    class ExtendedTallySheetVersion(ExtendedTallySheetReport.ExtendedTallySheetVersion):
        ...
        def html_letter(self, title="", total_registered_voters=None, signatures=[]):
            ...
            html = render_template(
                'ProvincialCouncilElection2021/PCE-CE-RO-V1-LETTER.html',
                content=content
            )
        ...
        def html(self, title="", total_registered_voters=None):
            ...
            html = render_template(
                'ProvincialCouncilElection2021/PCE-CE-RO-V1.html',
                content=content
            )
