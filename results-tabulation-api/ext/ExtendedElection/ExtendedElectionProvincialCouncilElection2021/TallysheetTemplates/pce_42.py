...
from ext.ExtendedElection.ExtendedElectionProvincialCouncilElection2021.TALLY_SHEET_CODES import PCE_42, PCE_CE_RO_PR_3, \
    PCE_R2
    ...
    return Template.create(
        ...
        templateRowTypesMap={
            "CANDIDATE_FIRST_PREFERENCE": {
                ...
                "derivativeRows": [
                    {"templateName": PCE_CE_RO_PR_3, "templateRowType": "CANDIDATE_FIRST_PREFERENCE"}
                ]
            },
